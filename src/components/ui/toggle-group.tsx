...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] data-[spacing=0]:data-[variant=outline]:rounded-3xl data-[spacing=0]:data-[variant=outline]:bg-muted data-[spacing=0]:data-[variant=outline]:p-0.5 data-vertical:flex-col data-vertical:items-stretch",
        className,
      )}
      {...props}
    >
